...
#import "NSDate+WHAdd.h"

@implementation NSDate (WHAdd)
...
- (NSString *)bbsSubTimeInfo
{
    ...
    return [NSString stringWithFormat:@"%02zd:%02zd", self.hour, self.minute];
}
...
+ (Boolean)isToday_Extension:(NSDate*)date
{
    ...
    return [curDate.formatYMD isEqualToString:date.formatYMD];
}
